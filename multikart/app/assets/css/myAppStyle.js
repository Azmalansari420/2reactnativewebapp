...
export default StyleSheet.create({
  ...
  bannerContainer: { height: 180, marginTop: 10 },
  bannerImage: { width: require("react-native").Dimensions.get("window").width - 20, height: 180, marginHorizontal: 10, borderRadius: 10 },

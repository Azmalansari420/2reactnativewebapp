...
const styles = StyleSheet.create({
  ...
  defaultAddress: { borderWidth: 1, borderColor: "#0a84ff" },
  name: { fontSize: 16, fontWeight: "bold" },
  phone: { fontSize: 14, color: "#555", marginVertical: 2 },
  addressText: { fontSize: 14, color: "#777" },
  defaultBadge: { backgroundColor: "#0a84ff", color: "#fff", paddingVertical: 3, paddingHorizontal: 8, borderRadius: 15, fontSize: 12, overflow: "hidden" },
  addAddressBtn: { backgroundColor: "#0a84ff", padding: 15, borderRadius: 10, alignItems: "center", marginTop: 10 },
  ...
  deliveryDate: { fontWeight: "bold", color: "#0a84ff" },
  ...
  viewDetails: { fontSize: 14, color: "#0a84ff", marginTop: 3 },
  proceedBtn: { backgroundColor: "#0a84ff", paddingVertical: 10, paddingHorizontal: 20, borderRadius: 8 },

...
const Payment = ({ navigation }) => {
  ...
  return (
    <>
      ...
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 100 }} nestedScrollEnabled={true}>
...
const styles = StyleSheet.create({
  ...
  viewDetails: { color: "#05a845", marginTop: 10, fontWeight: "bold" },
  proceedBtn: {
